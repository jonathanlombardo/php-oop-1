...
$productions = [
  new Production("V for Vendetta", "English", 9.2),
  new Production("Bianco rosso e verdone", "Italian", 8.5),
  new Production("Fight Club", "English", 9.1),
  new Production("intouchables", "French", 8.3),
  new Production("Die Welle", "German", 7.4),
  new Production("Death Note", "Japanese", 8.9),
];

$generes = [
  new Genre("Graphic novel", false, '
  ...
  new Genre("Socio-political Thriller", false, '
